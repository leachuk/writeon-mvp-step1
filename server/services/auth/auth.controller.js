  ...
  acl.allow([
    {
      roles:['recruiter'],
      allows:[
        {resources: ['getarticle', 'getspecifieduser', 'listmyarticles', 'listmytestcontent', 'recruitunitjobitem', 'getuserdetails', 'getdevemailfromdocid', 'find', 'getusertestresults'], permissions: ['read']},
